...
export default function Landing() {
  ...
  return <div className="landing-page">
    ...
    <main>
        ...
        <div className="hero-product" aria-label="Logiway operasyon paneli önizlemesi">
          <div className="product-glow"/><div className="app-window">
            ...
            <div className="app-content"><div className="app-top"><div><small>GÜNAYDIN, CAN</small><strong>Operasyon merkezi</strong></div><span className="live-pill"><i/> Canlı</span></div>
              ...
              <div className="map-card"><div className="map-head"><strong>Canlı operasyon</strong><span>Son 24 saat</span></div><div className="route-map"><svg viewBox="0 0 520 150" role="img" aria-label="İstanbul'dan Ankara'ya aktif rota"><path className="map-line muted" d="M25 105 C110 15,175 125,265 61 S405 16,500 80"/><path className="map-line active" d="M25 105 C110 15,175 125,265 61 S405 16,500 80"/></svg><span className="city city-one">İstanbul</span><span className="city city-two">Ankara</span><span className="truck-pin"><Truck size={15}/></span></div></div>
              <div className="shipment-row"><span className="shipment-icon"><PackageCheck size={18}/></span><span><strong>LW-2847</strong><small>İstanbul → Ankara</small></span><b>Yolda</b><span className="eta"><Clock3 size={13}/> 2s 40dk</span></div>
            </div>
      ...
      <section className="proof-strip"><span>Operasyonun her adımında</span><div><b>7/24</b><small>operasyon görünürlüğü</small></div><div><b>Tek panel</b><small>yük, araç ve sürücü yönetimi</small></div><div><b>Uçtan uca</b><small>ilandan teslimata takip</small></div></section>
